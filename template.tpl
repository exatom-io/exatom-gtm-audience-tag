...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Exatom Audience Tag",
  "categories": ["MARKETING", "REMARKETING"],
  "brand": {
    "id": "brand_dummy",
    "displayName": "Exatom",
  ...
  "description": "Utilise Exatom\u0027s real-time signals, such as form abandonment and hesitation, to build an audience and engage with them later.\n\nThis tag must be placed behind a consent management system.",
  "containerContexts": [
    "WEB"
  ]
}
...
// Build script URL
const scriptUrl = 'https://assets.exatom.io/activation.js?clientCode=' + clientCode.toUpperCase();
...
injectScript(
  scriptUrl,
  function () {
    log('Exatom audience script loaded successfully: ' + scriptUrl);
    data.gtmOnSuccess();
  },
  function (err) {
    log('Exatom audience script failed to load: ' + scriptUrl + ' - ' + err.message);
    data.gtmOnFailure();
  }
);
...
Created on 02/12/2025, 21:33:25
